...
import type { PageWithMetadata } from "@linkto/core";
  ...
  async function handleAvatarRemove() {
    ...
    if (page.user.avatar_url) {
      try {
         ...
         * https://linkto-storage-url/avatars/[userId]/[avatarName].png ->
         * -> [userId]/[avatarName].png
         */
        const storageAvatarName = page.user.avatar_url.replace(
          `${process.env.NEXT_PUBLIC_SUPABASE_STORAGE_URL}/avatars/?token=${process.env.TOKEN}`,
          ""
        );
