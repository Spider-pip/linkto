...
import { Plus, Dropdown, Feather } from "@linkto/gamut";
import { useAppContext } from "~/data/context";
import { useSupabase } from "~/lib/supabase";
import { Routes } from "~/data/enums/routes";
import type { FC } from "react";
import type { User } from "@linkto/core";
      ...
      >
        ...
        <Dropdown.Group>
          ...
          <Dropdown.ListItem
            as={Link}
            // @ts-ignore
            url="https://github.com/zaidmukaddam/linkto/issues/new?assignees=&labels=bug&template=bug-report-template.md&title="
            rightIcon={Feather}
            external
            noIcon
          >
