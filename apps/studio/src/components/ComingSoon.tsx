...
import { Heading, Text, Flex, Badge } from "@linkto/gamut";
...
const ComingSoon: FC<ComingSoonProps> = ({
  ...
  const BUG_REPORT_URL =
    "https://github.com/zaidmukaddam/linkto/issues/new?assignees=&labels=bug&template=bug-report-template.md&title=";
  const FEATURE_REQUEST_URL =
    "https://github.com/zaidmukaddam/linkto/issues/new?assignees=&labels=feature-request&template=feature_request.md&title=%5BRequest%5D+My+feature+request+title";
  const ROADMAP_URL = "https://github.com/zaidmukaddam/linkto/issues";
