...
import { Heading, Text, Flex, Toggle } from "@linkto/gamut";
import {
  PageLinkPreference,
  PageWithMetadata,
  useUpdateEffect,
    ...
    >
      ...
      <div>
        ...
        <Text size="sm" variant="light">
          Show your support towards Linkto by displaying our branding on your
          page
        </Text>
      </div>
      ...
      <div>
        ...
        <Text size="sm" variant="light">
          Visitors of your Linkto will see a Sensitive Content message before
