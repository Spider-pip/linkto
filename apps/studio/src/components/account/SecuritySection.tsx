...
import { Button, Heading, makeToast, Text } from "@linkto/gamut";
import { PageWithMetadata, storage, useDisclosure } from "@linkto/core";
    ...
    <>
      ...
      >
        ...
        <Text size="sm" variant="light" className="mb-8">
          This action will permanently delete your Linkto page along with all
