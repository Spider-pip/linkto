import { Container, Text } from "@linkto/gamut";
    ...
    <section className="bg-mauve-300">
      <Container as="div" className="pt-32 pb-28 flex flex-col items-center">
        ...
        <Text center className="xs:!text-xl !text-lg max-w-4xl">
          With Linkto you can create pages for things like blogs, merch,
        ...
        {/* <div className="grid lg:grid-cols-3 md:grid-cols-2 w-full xl:gap-8 gap-4 mt-20">
          <FeatureCard
            ...
            description="Linkto makes it super simple to create and manage new links, allowing your audience to engage with your online content through a custom page that reflects your brand."
          />
          <FeatureCard
